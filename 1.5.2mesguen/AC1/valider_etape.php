...
*/
	...
	$sql2 = 'SELECT max( convert( `ETPID` , signed integer ) ) +1 FROM `etape` ';
	$ETPID = champSQL ($sql2);
	...
	if ($result) {
		if ($result2) {
			echo "<meta http-equiv='refresh' content='0;url=Modifier_les_tournees.php?message2=<font color=green> Ajout realisee </font>'>";
		} else {
